...
def prepare_tsp_config(show=True):
    ...
    parser.add_argument('--save_after', type=int, default=50, help='after how many epochs the model will check to store models during training')
    parser.add_argument('--resume_training', type=bool, default=False, help='Whether to resume training from a previous training or not')
    parser.add_argument('--iteration', type=int, default=1, help='number of iterations')
    parser.add_argument('--maximize', type=bool, default=False, help='whether it is a maximization problem or not')
    parser.add_argument('--greedy', type=bool, default=False, help='whether to use greedy action or sampling')
    parser.add_argument('--epoch', type=int, default=10000, help='number of epochs')
    parser.add_argument('--inference', type=bool, default=False, help='inference mode or not')
    parser.add_argument('--lr_step', type=int, default=50, help='number of steps to reduce learning rate')
    parser.add_argument('--lr_step_decay', type=float, default=.99, help='factor to reduce learning rate')
